...
/* ═══════════════════════════════════════════════════════════════
   GLOBAL FLOWS — cross-cutting queries not tied to a single claim
   ═══════════════════════════════════════════════════════════════ */
const GLOBAL_FLOWS = {
  ...
  clarification: {
    ...
    response: {
      type: "clarification",
      headline: "Happy to help — just want to make sure I give you the right answer.",
      question: "What are you looking to understand?",
      details: ["You can ask me about any of your 5 active claims, your overall financial exposure, what actions you need to take, how your deductible works, appeal deadlines, or what your plan covers."],
    },
    suggestions: [
      "Give me an overview of all my claims",
      "What’s my total financial exposure?",
      "What do I need to do urgently?",
      "How does my deductible work?",
      "When do my appeal deadlines expire?",
  ...
  overview: {
    tools: [
      T.eob("Loading all 5 active claims · SFP-01 through SFP-05"),
      T.accum("Deductible: $620/$1,500 · OOP: $820/$4,500 · Plan year 2026"),
      T.reconcile("Scanning consistency across all claims · 2 denials flagged for action"),
    ],
    response: {
      type: "overview",
      headline: "You have 5 claims on file. 2 need immediate action, 1 is pending, 1 is resolved.",
      details: [
        "**MRI — Right Knee (SFP-01):** DENIED · $1,250 shown as your responsibility. This is the **provider’s error** — they didn’t get prior auth. Your real share if resolved: ~$74.",
        "**Annual Wellness (SFP-02):** APPROVED · $0 owed. Fully covered under preventive care. Nothing to do.",
        "**Physical Therapy x6 (SFP-03):** PARTIAL · $220 owed. This is a legitimate cost-share — deductible + coinsurance. Not disputable.",
        "**Dermatology Visit (SFP-04):** PENDING · Processing until ~April 3rd. Estimated $54–$270 once processed.",
        "**ER Visit (SFP-05):** DENIED · $2,800 shown. The **No Surprises Act** caps your real share at ~$220–$300. Do NOT pay the $2,800 bill.",
      ],
    },
    suggestions: [
      "What’s my total financial exposure?",
      "What do I need to do urgently?",
      "Tell me about my MRI claim",
      "Tell me about my ER visit claim",
    ],
  },
  ...
  financial_overview: {
    tools: [
      T.accum("Deductible: $620/$1,500 · OOP: $820/$4,500"),
      T.reconcile("Paper total $4,270 vs recoverable exposure · NSA + provider error adjustments"),
    ],
    response: {
      type: "financial_summary",
      headline: "Paper total: $4,270. Real exposure if you take action: $440–$794.",
      details: [
        "The EOBs show **$4,270 total member responsibility** across your denied and partial claims. That number is misleading.",
        "**SFP-01 (MRI $1,250):** Provider’s fault. If they resubmit, your real share drops to ~**$74**. Potential savings: $1,176.",
        "**SFP-03 (PT $220):** Legitimate. Budget this one.",
        "**SFP-05 (ER $2,800):** No Surprises Act applies. Real share ~**$220–$300**. Do NOT pay $2,800. Potential savings: ~$2,500.",
        "**SFP-04 (Pending ~$54–$270):** Estimate only — final number on ~April 3rd.",
        "**If you take action on SFP-01 and SFP-05:** Total real exposure lands at **$494–$864** — not $4,270.",
      ],
      card: { type: "financial_card", deductible: { used: 620, max: 1500 }, oop: { used: 820, max: 4500 }, potentialSavings: "~$3,676" },
    },
    suggestions: [
      "What do I need to do urgently?",
      "How do I appeal the ER denial?",
      "How do I fix the MRI denial?",
      "How does my deductible work?",
    ],
  },
  ...
  urgent_items: {
    tools: [
      T.action("Scanning all claims for required member action · urgency ranking"),
      T.timeline("SFP-05 deadline: Sep 1, 2026 · SFP-01 deadline: Sep 10, 2026 · 168-159 days remaining"),
    ],
    response: {
      type: "action_plan",
      headline: "2 claims require your action. Start with the ER visit — it’s the largest dollar risk.",
      steps: [
        {
          num: 1,
          title: "ER Visit (SFP-05) — Do NOT pay the $2,800 bill",
          detail: "File a member appeal citing the **No Surprises Act §2799B-1**. Emergency care must be covered at in-network rates regardless of network status. Your real share is ~$220–$300. Deadline: **September 1, 2026**.",
          time: "This week",
        },
        {
          num: 2,
          title: "MRI Denial (SFP-01) — Call Dr. Whitfield’s billing office",
          detail: "Ask them to submit a **retroactive authorization**. Prior auth was their contractual obligation as an in-network provider. Your real share if resolved: ~$74. Deadline: **September 10, 2026**.",
          time: "Within 14 days",
        },
        {
          num: 3,
          title: "PT Cost-Share (SFP-03) — Pay $220",
          detail: "This is a legitimate deductible + coinsurance charge. Not disputable. Budget it and move on.",
          time: "When billed",
        },
      ],
      card: { type: "timeline_card", deadlineLabel: "Nearest Deadline", deadline: "September 1, 2026", daysRemaining: 159 },
    },
    suggestions: [
      "How do I appeal the ER visit?",
      "What should I say to the MRI provider?",
      "What’s my total financial exposure?",
    ],
  },

  /* ── Deductible / accumulator status ── */
  accumulator_status: {
    tools: [
      T.accum("Deductible: $620/$1,500 · OOP: $820/$4,500 · Remaining: $880 ded · $3,680 OOP"),
    ],
    response: {
      type: "financial_summary",
      headline: "You’ve used $620 of your $1,500 deductible and $820 of your $4,500 OOP max.",
      details: [
        "**Deductible ($620 used / $1,500 max):** You have **$880 left** before the plan starts sharing costs at 80/20. Most services apply to this first — except preventive care (like your wellness visit) which skips it entirely.",
        "**Out-of-Pocket Max ($820 used / $4,500 max):** Once you hit $4,500 total, the plan pays **100%** for in-network services for the rest of the plan year. You have $3,680 remaining.",
        "**What counts toward both:** Deductibles, coinsurance, and copays for in-network services all count. Premiums do NOT count. Denied claims only count once they’re processed at the correct amount.",
        "**Impact of pending claims:** If SFP-01 and SFP-05 resolve at their corrected amounts, they’ll push your deductible usage higher — potentially meeting it this plan year depending on your future care.",
      ],
      card: { type: "financial_card", deductible: { used: 620, max: 1500 }, oop: { used: 820, max: 4500 }, potentialSavings: null },
    },
    suggestions: [
  ...
  appeal_deadlines: {
    tools: [
      T.timeline("SFP-01: denied 2026-03-14 · 180-day window · deadline Sep 10 · 168 days left"),
      T.timeline("SFP-05: denied 2026-03-05 · 180-day window · deadline Sep 1 · 159 days left"),
    ],
    response: {
      type: "action_plan",
      headline: "You have 2 open appeal windows. Both are within their 180-day deadline.",
      steps: [
        {
          num: 1,
          title: "SFP-05 — ER Visit appeal deadline",
          detail: "Denial date: **March 5, 2026**. Appeal must be filed by **September 1, 2026** — **159 days remaining**. This is the higher-dollar claim ($2,800 shown vs ~$300 real). Cite No Surprises Act.",
          time: "159 days left",
        },
        {
          num: 2,
          title: "SFP-01 — MRI appeal deadline",
          detail: "Denial date: **March 14, 2026**. Appeal must be filed by **September 10, 2026** — **168 days remaining**. Start with the provider before filing your own appeal.",
          time: "168 days left",
        },
        {
          num: 3,
          title: "SFP-03 — Not appealable (CO-45)",
          detail: "The $220 PT cost-share is a contractual rate adjustment, not a denial. CO-45 codes cannot be appealed by the member.",
          time: "N/A",
        },
      ],
      card: { type: "timeline_card", deadlineLabel: "Nearest Deadline", deadline: "September 1, 2026", daysRemaining: 159 },
  ...
  plan_overview: {
    tools: [
      T.rag("2026 Self-Funded PPO · Acme Industries · Deductible, coinsurance, OOP, benefit categories"),
    ],
    response: {
      type: "explanation",
      headline: "Your plan is a 2026 Self-Funded PPO through Acme Industries. Here’s how it works.",
      details: [
        "**Deductible — $1,500 individual:** Most services apply here first. You pay 100% until you’ve spent $1,500 in-network. Preventive care skips this entirely.",
        "**Coinsurance — 80/20 after deductible:** Once the deductible is met, the plan pays 80% and you pay 20% for most in-network services.",
        "**Out-of-Pocket Max — $4,500 individual:** Once you’ve paid $4,500 total (deductible + coinsurance), the plan pays 100% for the rest of the plan year.",
        "**Preventive Care:** 100% covered, no deductible, no coinsurance. Annual wellness, vaccines, cancer screenings, and USPSTF Grade A/B services.",
        "**Emergency Care:** Covered at in-network rates even at out-of-network ERs (No Surprises Act). You pay in-network deductible + 20% coinsurance.",
        "**Advanced Imaging (MRI/CT):** Requires prior authorization 5 business days in advance at outpatient facilities. ER exception waives this requirement.",
        "**Physical Therapy:** 20 sessions per year, 20% coinsurance after deductible. You have 14 sessions remaining in 2026.",
        "**Specialist Visits:** In-network, 20% coinsurance after deductible. No referral required under this PPO.",
      ],
    },
    suggestions: [
      "How does my deductible work?",
      "What do I owe across all claims?",
...
function classifyGlobalIntent(input) {
  const s = input.toLowerCase();
  const has = (...words) => words.some(w => s.includes(w));

  // Explicit overview requests
  if (has("all my claims", "overview", "summary", "all claims", "show me everything",
          "what do i have", "status of all", "give me a rundown", "rundown"))
    return "overview";

  // Financial / cost exposure
  if (has("total", "overall", "exposure", "all together", "in total", "everything i owe",
          "total cost", "grand total", "all my bills", "how much do i owe"))
    return "financial_overview";

  // Urgent / action items
  if (has("urgent", "action", "what do i need to do", "what should i do",
          "priority", "most important", "what’s next", "next step", "to-do",
          "what first", "where do i start", "what to do"))
    return "urgent_items";

  // Deductible / accumulator
  if (has("deductible", "out-of-pocket", "oop", "accumulator", "max",
          "how much have i paid", "how close am i", "remaining", "progress"))
    return "accumulator_status";

  // Appeal deadlines
  if (has("deadline", "appeal window", "how long do i have", "when do i need to",
          "expire", "time limit", "180 day", "appeal by"))
    return "appeal_deadlines";

  // Plan / benefits coverage
  if (has("plan", "benefit", "cover", "coverage", "what’s covered", "what is covered",
          "explain my benefit", "how does my plan", "how does the plan",
          "coinsurance", "copay", "network", "in-network", "ppo"))
    return "plan_overview";

  return null;
}

/* ── Detect genuine questions that warrant clarification ── */
function isGenuineQuestion(input) {
  const s = input.toLowerCase().trim();
  if (s.length < 4) return false;
  return (
    s.includes("?") ||
    /^(what|how|why|when|who|can|could|should|is|are|do|does|tell|explain|help|show|give|which|where)/.test(s)
  );
}

/* ── Global flow finder ── */
function findGlobalFlow(input) {
  const intent = classifyGlobalIntent(input);
  return intent ? GLOBAL_FLOWS[intent] : null;
}
